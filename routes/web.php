...
Route::group(['middleware' => ['get.menu']], function () {
    ...
    Route::group(['middleware' => ['role:admin']], function () {
        ...
        // User list routes
        Route::resource('userlist', 'UserLists');
        Route::resource('groups', 'GroupsController');
        Route::resource('useractivities', 'UserActivitiesController');
        Route::resource('userinterests', 'UserInterestsController');
        Route::resource('cando', 'CanDoController');
        Route::resource('cannotdo', 'CannotDoController');
        Route::resource('goals', 'GoalController');
        Route::resource('groupmember', 'GroupMemberController');
        ...
        // Route::get('/userlist', 'UserLists@show');
